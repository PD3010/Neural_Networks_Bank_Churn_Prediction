...
Python, Pandas, Scikit-Learn, Matplotlib, Seaborn, EDA, Statistics, Neural Network, Keras, Tensorflow, Grid-Search CV, Sampling Technique (SMOTE), Optimizer, Classification, Ephocs, Gradient Descent, Classification Report
